  ...
  <header class="sticky top-0 bg-white z-30 shadow-lg">
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 -mb-px">
        <div class="flex">
          <button class="text-slate-500 hover:text-slate-600 md:hidden" @click.stop="$emit('toggle-sidebar')">
          ...
          <div v-show="session.name != ''">
            <a href="/homepage/index" class="">
              <img src="/src/images/cropped-logo-jobhun-3.png" alt="Logo Jobhun" class="h-8 md:h-10 md:ml-0 ml-5" />
            </a>
          </div>
        </div>
