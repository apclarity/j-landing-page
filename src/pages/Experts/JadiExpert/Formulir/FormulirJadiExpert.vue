...
const deleteAvailableServices = (availableServices) => {
    let selectedItems = formulirJadiExpert.value.availableServices
    let index = -1
    ...
    formulirJadiExpert.value.availableServices = selectedItems
}
</script>
            ...
            <div class="sm:px-6 lg:px-8 px-6">
                ...
                <div class="mt-1">
                    <Multiselect :close-on-select="false"
                        ...
                        :searchable="true"
                        v-model="formulirJadiExpert.availableServices">
                    ...
                    <div class="mb-2" v-if="formulirJadiExpert.availableServices != ''">
                        <div>
                            <span id="badge-dismiss-default" v-for="availableServices in formulirJadiExpert.availableServices"
