                ...
                <div class="max-w-xl mt-5">
                    <div>
                        ...
                        <div class="flex items-center" v-for="pelatihan in radioPelatihan" :key="pelatihan">
                            <input id="default-radio-1" type="radio" v-model="formExpertPelatihan.typePelatihan"
                            ...
                            <label for="default-radio-1" class="ml-2 text-sm font-medium text-black">{{ pelatihan.text }}</label>
                        </div>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <input
                            class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-md"
                            type="email" required placeholder="Input angka" v-model="formExpertPelatihan.session" />
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <input
                            class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-full"
                            required v-model="session" @click.prevent="dropdownDay = !dropdownDay" />
                        <div v-show="dropdownDay" class="z-20 bg-white border border-slate-200 pt-1.5 rounded shadow-lg mt-1">
                            <ul class="overflow-y-auto pb-3 h-48 text-sm text-white">
                                <li class="relative cursor-default select-none" v-for="hour in hours" :key="hour.text">
                                    <div class="flex items-center p-2">
                                        <input class="w-4 h-4 text-jobhunGreen ring-0 bg-gray-100 rounded border-gray-300 ">
                                        <label class="ml-2 w-full text-sm font-medium text-black rounded">
                                            {{hour.text}}
                                        </label>
                                    </div>
                                </li>
