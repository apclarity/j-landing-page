...
// const filterExperts = computed(()=>{
//     return experts.filter(expert => expert.name.toLowerCase().includes(this.searchCariExpert.company.toLowerCase()))
// })
</script>
<template>
    <div class="">
                ...
                <div class="">
                        ...
                        <div class="flex-none md:w-1/3 lg:w-1/5 mr-0 md:mr-5 sm:mt-10 md:mt-40 bg-white shadow-lg rounded-sm border border-slate-200 p-5">
                            <form action="" class="">
                                ...
                                <div class="text-left mt-2">
                                    ...
                                    <input class="form-input align-middle shadow my-1 focus:outline-none focus:bg-white focus:border-emerald-500 w-full"
                                        type="text" required placeholder="Nama expert" v-model="advanceFilterCariExpert.company" />
                                </div>
                                <div class="text-left mt-2">
                                    <span class="text-sm font-medium text-jobhunGreen">
                                        Keahlian
                                ...
                                <div class="text-left mt-2">
                                    ...
                                    <div>
                                        <button class="text-gray-900 mt-1 bg-white focus:outline-none hover:bg-gray-100 rounded-xl p-1">
                                            <!-- <Rating :ratingValues="rating.five" class="justify-items-center" /> -->
                    ...
                    <!-- <div class="mt-5">
                        <form class="hidden lg:block">
                            ...
                            <button class="bg-jobhunGreen text-sm h-9 hover:bg-emerald-600 text-white px-5 w-24 rounded align-middle">
                                Cari
                            </button>
                            <div class="my-3">
                                <span id="badge-dismiss-default" v-for="sector in advanceFilterCariExpert.sectors" :key="sector"
