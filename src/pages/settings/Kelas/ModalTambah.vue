...
const { formOpenStatus } = toRefs(props)
...
<template>
    <ModalAction id="newsletter-modal" :modalOpen="formOpenStatus" @close-modal="closeForm">
        ...
        <div class="mb-2 text-center">
            <div class="text-lg font-semibold text-slate-800">Tambah kelas</div>
        </div>
        <!-- Modal content -->
        <div class="px-5 py-4">
            <div class="space-y-3">
                <form class="flex max-w-sm m-auto">
                    <div class="grow mr-2">
                        <input placeholder="Nama kelas" class="form-input w-full px-2 py-1 focus:border-emerald-500" type="text" />
                    </div>
                    <button type="submit"
