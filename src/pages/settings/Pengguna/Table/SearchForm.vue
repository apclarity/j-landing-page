...
<template>
  <form class="relative" @submit.prevent="">
    ...
    <input id="action-search" class="pl-9 focus:ring-jobhunGreen hover:ring-emerald-500 border-0 bg-gray-100 rounded-lg" type="text" :placeholder="placeholder" @input="changeModelValue($event)" @keyup.enter="clickSearchButton" />
