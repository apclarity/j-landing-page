<template>
  ...
  >
    <div v-show="modalOpen" :id="id" class="fixed inset-0 z-50 overflow-hidden flex items-center my-4 justify-center px-4 mx-10 sm:px-6" role="dialog" aria-modal="true">
      <div ref="modalContent" @click.stop="closeHandler" class="bg-white rounded shadow-lg overflow-auto max-w-full max-h-full">
        <!-- Modal header -->
