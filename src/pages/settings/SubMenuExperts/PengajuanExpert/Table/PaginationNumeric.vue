...
<template>
  <div class="flex justify-center">
    <nav class="flex" role="navigation" aria-label="Navigation">
      <div class="mr-2">
        <button class="inline-flex items-center justify-center rounded leading-5 px-2.5 py-2 bg-white border border-slate-200 text-jobhunGreen"
        :class="{
      ...
      <ul class="inline-flex text-sm font-medium -space-x-px shadow-sm" >
        <li v-for="page in props.page" :key="page">
          <div class="inline-flex items-center justify-center rounded-l leading-5 px-3.5 py-2 bg-white border border-slate-200 text-jobhunGreen">
            <a href="#">
              {{ page }}
            </a>
          </div>
      ...
      <div class="ml-2">
        <button class="inline-flex items-center justify-center rounded leading-5 px-2.5 py-2 bg-white hover:bg-jobhunGreen border border-slate-200 text-jobhunGreen hover:text-white shadow-sm"
        :class="{
