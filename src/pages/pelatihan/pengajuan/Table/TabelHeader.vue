...
const props = defineProps({
  page: Number,
  perPage: Number,
  tablePelatihan: Array,
  total: Number,
  deleteExpert: Object
})

const { page, perPage, tablePelatihan, total } = toRefs(props)
      ...
      <div class="overflow-x-auto">
        <table class="table-auto w-full">
          ...
          <tbody class="text-sm divide-y divide-slate-200">
            <TabelData
              v-for="(expertPelatihan, index) in tablePelatihan"
              :key="expertPelatihan.id"
              :value="expertPelatihan.id"
              :tableExpertPelatihan="expertPelatihan"
