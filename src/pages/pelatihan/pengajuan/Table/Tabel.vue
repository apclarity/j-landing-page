...
await tableExpertPermanentStore.getDataTablePelatihan()
const { tablePelatihan, pagination } = storeToRefs(tableExpertPermanentStore)
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div class="sm:flex sm:justify-between sm:items-center mb-5">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
              <a href="#"
                ...
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Pelatihan > Pengajuan ✨</h1>
              </a>
            </li>
          </ol>
        </div>
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
          ...
          <router-link to="/pelatihan/tambahpelatihan/" class="btn bg-emerald-500 hover:bg-emerald-600 text-white">
