<script setup>
    ...
    const items = [
        ...
        {
            img: new URL("../../images/carousel-homepage/Logo Web Baru-02.svg", import.meta.url),
            id: 1,
        },
        {
            img: new URL("../../images/carousel-homepage/Logo Web Baru-03.svg", import.meta.url),
            id: 2,
        },
    ]
...
<template>
    <div class="xl:px-80 sm:px-10 md:px-20 mt-5">
