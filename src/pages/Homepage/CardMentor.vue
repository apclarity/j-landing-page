            ...
            <div class="grow flex flex-col p-5">
                <div class="grow">
                    <header class="mb-3">
                        ...
                        <ModalPreview :isPreviewMentor="isPreviewMentor" :expertID="expert.id" :service="expert.service" @close-modal="isPreviewMentor = false" />
                    </header>
                    <ul class="text-sm space-y-2 mb-5">
                        <li class="flex items-center">
                            ...
                            <p class="truncate">{{ expert.profession}}</p>
                        </li>
                        <li class="flex items-center">
                            ...
                            <router-link to="google.com" class=" space-x-1 line-clamp-1 hover:line-clamp-none">
                                <div v-for="bidang in expert.sector" :key="bidang"
                        ...
                        <li class="flex items-center">
                            ...
                            <router-link to="google.com" class=" space-x-1 line-clamp-1 hover:line-clamp-none">
                                <div v-for="service in expert.service" :key="service" class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-md text-center px-2 py-0.5 my-1">
                                    {{service}}
                                </div>
                            </router-link>
                        </li>
                    </ul>
                    <Rating :ratingValues="expert.star" />
                </div>
            </div>
        </div>
    </div>
