                    ...
                    <ul class="text-sm space-y-2 mb-5">
                        ...
                        <li class="flex items-center">
                            ...
                            <router-link to="google.com" class=" space-x-1 line-clamp-1 hover:line-clamp-none">
                                <div v-for="bidang in expert.sectors" :key="bidang"
                        ...
                        <li class="flex items-center">
                            ...
                            <router-link to="google.com" class=" space-x-1 line-clamp-1 hover:line-clamp-none">
                                <div v-for="service in expert.available_services" :key="service" class="inline-flex text-sm font-medium bg-emerald-100 text-jobhunGreen rounded-md text-center px-2 py-0.5 my-1">
                                    {{serviceMap[service]}}
                                </div>
                            </router-link>
                        </li>
