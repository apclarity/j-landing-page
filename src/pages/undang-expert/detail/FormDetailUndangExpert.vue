        ...
        <div class="flex-auto max-w-4xl min-w-0 mx-auto pt-6 lg:px-8 px-6 lg:pt-4 md:mt-0">
            <div>
                ...
                <input
                    ...
                    readonly v-model="formDetailDashboardUndangExpert.from" type="text" />
            </div>
            <div class="mt-4">
                ...
                <textarea rows="5"
                    class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-full"
                    readonly v-model="formDetailDashboardUndangExpert.description" type="text" />
            </div>
            <div class="mt-4">
                <label class="block text-sm font-medium mb-1 text-black">Nama acara/kegiatan</label>
                <input
                    class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-full"
                    v-model="formDetailDashboardUndangExpert.eventName" readonly type="text" />
            </div>
            <div class="mt-4">
                <label class="block text-sm font-medium mb-1 text-black">Penjelasan tentang acara/kegiatan</label>
                <textarea rows="5"
                    class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-full"
                    readonly v-model="formDetailDashboardUndangExpert.eventDescription" type="text" />
            </div>
            <div class="mt-4">
                <label class="block text-sm font-medium mb-1 text-black">Tanggal pelaksanaan acara</label>
                <div class="flex items-center space-x-2">
                    <DateSingle v-model="formDetailDashboardUndangExpert.date" />
                </div>
            </div>
            <div class="mt-4">
                <label class="block text-sm font-medium mb-1 text-black">Format acara</label>
                <div class="flex items-center">
                    <input type="radio" v-model="formDetailDashboardUndangExpert.typePelatihan" readonly value="Talkshow"
                ...
                <div class="flex items-center">
                    <input type="radio" v-model="formDetailDashboardUndangExpert.typePelatihan" readonly value="Workshop"
                        class="w-4 h-4 text-jobhunGreen bg-gray-200 border-gray-200 focus:ring-jobhunGreen focus:ring-1 hover:ring-jobhunGreen hover:ring-1">
                    <span class="text-sm ml-1 text-black">Workshop</span>
                </div>
                <div class="flex items-center">
                    <input type="radio" v-model="formDetailDashboardUndangExpert.typePelatihan" readonly value="Lainnya"
                        class="w-4 h-4 text-jobhunGreen bg-gray-200 border-gray-200 focus:ring-jobhunGreen focus:ring-1 hover:ring-jobhunGreen hover:ring-1">
            ...
            <div class="mt-4">
                ...
                <input
                    class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-md"
                    @input="formatBudget" readonly v-model="formDetailDashboardUndangExpert.budget" type="text" />
            </div>
            <div class="mt-4">
                ...
                <textarea rows="5"
                    class="border-0 bg-gray-100 hover:ring-emerald-500 rounded-lg focus:ring-jobhunGreen p-1.5 text-sm w-full"
                    readonly v-model="formDetailDashboardUndangExpert.topic" type="text" />
            </div>
        </div>
    </form>
</template>
