...
const { dataProfile, testimonies } = props
...
<template>
    ...
    <div class="lg:px-60 px-10 mb-10">
        <div class="mb-6 sm:mb-3 md:flex">
            ...
            <div class="text-sm mt-5 sm:mt-0 ml-5 shrink w-full">
        ...
        <div class="shrink w-full">
            ...
            <div class="p-4 rounded-lg" v-if="openTab === 2">
                <div v-for="testimoni in testimonies" :key="testimoni">
                    <OrderingHistory :testimonies="testimoni" :ratingValues="testimonies.rating"  />
                </div>
            </div>
        </div>
    </div>
